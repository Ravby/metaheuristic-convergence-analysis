...
public class BenchmarkManager {
    ...
    private BenchmarkManager() {
        ...
        BenchmarkInfo cec2024 = new BenchmarkInfo("CEC2024", BenchmarkId.CEC2024, 29, 25, 1000, new int[]{30}, new int[]{300000}, new String[]{"L-SRTDE", "RDE", "BlockEA", "mLSHADE-RL", "jSOa", "iEACOP"}); //29 files for each algorithm
